        ...
        <div className="container my-3" style={props.mode === "light" ? { color: "black" } : { color: "white" }}>
            ...
            <div className="accordion my-3" id="accordionExample">
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style={props.mode === "light" ? lightMode : darkMode}>
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample" style={props.mode === "light" ? lightMode : darkMode}>
                        <div className="accordion-body">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample" style={props.mode === "light" ? lightMode : darkMode}>
                        <div className="accordion-body">
